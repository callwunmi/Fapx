...
namespace Fapx_Web.Services
{
    public class LogService
    {
        ...
        protected ILog PaymentFileUpload;

        private LogService()
        {
            monitoringLogger = LogManager.GetLogger("MonitoringLogger");
            debugLogger = LogManager.GetLogger("DebugLogger");
            PaymentFileUpload = LogManager.GetLogger("PaymentFileUpload");
        }

        public static void PaymentFileUploadInfo(string message)
        {
            _instance.PaymentFileUpload.Info(message);
        }

        public static void PaymentFileUploadError(string message, System.Exception exception)
        {
            _instance.PaymentFileUpload.Error(message, exception);
        }
